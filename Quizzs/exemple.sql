...
CREATE TABLE CHOIX (
  ...
  numero_qst int(11) NOT NULL,
  vrai tinyint(4) NOT NULL DEFAULT '0',
  choix text COLLATE utf16_bin NOT NULL,
  PRIMARY KEY (id)
...
INSERT INTO CHOIX (id, question_number, is_correct, choice) VALUES
...
INSERT INTO QUESTIONS (numero_qst, question) VALUES
