...
<body style="padding-left: 10em;">
    <?php if ($_GET['success'] == 1) echo '<p style="background-color: red; color: white; font-size: 40px; font-weight: 700; padding: 0.5em 1em; border-radius: 3em; text-align: center;">Utilisateur supprimé avec succès!</p>'; ?>
