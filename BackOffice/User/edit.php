    ...
    <div id="div1">
        <form method="post" id="Info_gen" action="apply_edit.php">
            ...
            <div class="edit">
                ...
                <input type="text" name="id_USER" class="Input_edit value" style="cursor: not-allowed;" value="<?php echo $users[0]['id_USER']; ?>" readonly>
            </div>

            <div class="edit">
                <span class="title_edit">Nom</span>
                <input type="text" name="lastname" class="Input_edit value" value="<?php echo $users[0]['lastname']; ?>">
            </div>

            <div class="edit">
                <span class="title_edit">Prenom</span>
                <input type="text" name="firstname" class="Input_edit value" value="<?php echo $users[0]['firstname']; ?>">
            </div>

            <div class="edit">
                <span class="title_edit">Email</span>
                <input type="email" name="email" class="Input_edit value" value="<?php echo $users[0]['email']; ?>">
            </div>

            <div class="edit">
                <span class="title_edit">Image</span>
                <input type="text" name="path_pp" class="Input_edit value" value="<?php echo $users[0]['path_pp']; ?>">
            </div>
