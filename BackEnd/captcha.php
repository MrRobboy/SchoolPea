...
echo ('<head><link rel="stylesheet" type="text/css" href="./style.css"></head><form method="post" style="margin : 5rem auto; justify-content : center; display : flex; font-size: 1.5rem;" action="./Verif_captcha.php" >' . $question);
