...
echo ('<head><link rel="stylesheet" type="text/css" href="./style.css"></head><body><form method="post" style="margin : 5rem auto; justify-content : center; display : flex; font-size: 1.5rem;" action="./Verif_captcha.php" >' . $question);
echo ('<input name="textCaptchaAnswer" style="margin : 0 0.5rem; font-size : 1.5rem" type="text" required />');
echo ('<input type="submit" style ="padding: 0 0.5rem; font-size : 1rem;" value="Submit" name="submit"></form></body>');
