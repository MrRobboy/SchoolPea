...
<head>
        <meta charset="UTF-8">
        <title>Confirmation Supression du compte</title>
</head>

<body style="padding: 5em;">
        <div style="margin: 0 auto; justify-content: center;align-items: center; text-align: center;">
                <h1 style="margin: 3em 0;">Supprimer votre compte : <?php echo $_GET['id'] ?></h1>
                <a style="text-align: center; margin:5em; padding: 0.5em 1em; font-size: 20px; font-weight: 400; text-decoration: none; background-color: red; color: white; border-radius: 1em;" href="delete.php?id=<?php echo $_GET['id']; ?>"> Supprimer mon compte</a>
